package com.mercadolibre.rampup_angelmarin.config;

import static com.mercadolibre.rampup_angelmarin.util.ScopeUtils.getScopeValue;
import static com.mercadolibre.rampup_angelmarin.util.ScopeUtils.isLocalScope;
  ...
  public OpenAPI customOpenAPI(
    ...
    Info info = new Info()
        ...
        .contact(
            new Contact()
                .name("angel marin")
                .email("angel.marin@mercadolibre.com.co"));
